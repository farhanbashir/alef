...
<section class="content">
    ...
    <div class="row">
        <div class="col-xs-6">
            <p class="lead">KEY # <?php echo ucfirst($detail['key']);?></p>
            <?php
            if($error != "")
            {
            ?>    
            ...
            <div class="table-responsive">
                ...
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form name="edit_event" id="edit_event" action="" method="POST" onsubmit="return check_edit_key();">
                    ...
                    <input name="uniqid" id="uniqid" value="<?php echo $uniqid;?>" type="hidden" />
                        ...
                        <div class="box-footer">
                            <button type="submit" class="btn btn-primary">Edit Key</button>
                        </div>
                    </form>
                </div>
